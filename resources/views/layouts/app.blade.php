    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
         <!-- <a class="sidebar-brand brand-logo" href="index.html">{{ config('app.name', 'Laravel') }}</a>
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="{{ asset('images/faces/ruan.png') }}" alt="">
                  <span class="count bg-success"></span>
                </div>
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">{{isset(auth()->user()->name) ? auth()->user()->name : ''}}</h5>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('/aquas')}}">
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
              </span>
              <span class="menu-title">Aquarium</span>
            </a>
          </li>
          <!--<li class="nav-item menu-items">
              ...
              <!--<li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="{{ asset('images/faces/ruan.png') }}" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">{{isset(auth()->user()->name) ? auth()->user()->name : ''}}</p>
        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Reef das antigas</span>
